<template>
  ...
  <div v-else class="mx-auto max-w-md min-h-screen w-1/2 p-4 justify-center flex items-center">
    <div class="border p-4 space-y-2 dark:border-gray-700 dark:bg-gray-800">
      <div class="text-lg font-semibold dark:text-white">Login / Sign up</div>
      <form class="space-y-2" @submit.prevent="login">
        <div v-if="error" class="text-red-600 bg-red-100 p-2">{{ error }}</div>
        <input
          v-model="username"
          required
          type="text"
          placeholder="Username"
          class="w-full p-2 border dark:bg-gray-800 dark:text-white"
        />
        <input
          v-model="password"
          required
        ...
        <div class="text-right space-x-2">
          <button
            ...
            class="bg-green-600 text-white p-2 hover:bg-green-700"
          ...
          <button
            ...
            class="bg-blue-600 text-white p-2 hover:bg-blue-700"
